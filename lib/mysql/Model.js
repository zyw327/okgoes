...
class MysqlModel {
     ...
     * @param {String} alias 
     */
    constructor(table, defineField, charSet) {
        ...
        this.tableCharSet = charSet || 'utf8';
    }
    ...
    */
     ...
     * create table
     */
    async create(isForce = false, transaction = null, charSet) {
        charSet = charSet || this.tableCharSet;
        let createSql = "CREATE TABLE `" + this.table + '` (' + this.mysqlFields.createSql + ') ENGINE=INNODB DEFAULT CHARSET=' + charSet;
        if (isForce) {
