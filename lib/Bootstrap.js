...
module.exports = class Bootstrap {
    ...
    constructor(ctx, next) {
        this.request = new Request(ctx.request, new Cookie(ctx.cookies), new Session(ctx.session));
    ...
    async run() {
        try {
            ...
            if (typeof(controller._init) === 'function') {
                controller._init.call(this).toString() === '[object Promise]' ? await controller._init() : !controller._init();
            }
